...
//		System.out.println(node);
		...
		ArrayList<LinkedList<Integer>> allSequences = bst.allSequences();
		
		for(LinkedList<Integer> sequence: allSequences) System.out.println(sequence);
		
		System.out.println(bst.formString());
	}
